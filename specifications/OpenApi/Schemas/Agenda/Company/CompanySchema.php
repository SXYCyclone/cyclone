...
class CompanySchema extends SchemaFactory
{
    /**
    ...
    {
        return Schema::object('CompanyEloquentModel')
            ->properties(
                Schema::string('id')->default(null),
                Schema::string('fiscal_name')->default(null),
                Schema::string('social_name')->default(null),
                Schema::string('vat')->default(null),
